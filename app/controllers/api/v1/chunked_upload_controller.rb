module Api
  module V1
    class ChunkedUploadController < Api::V1::ApiController
      ...
      def upload_chunk
        ...
        upload_session = current_user.chunked_uploads.find(upload_id)
      ...
      def chunk_file_path(upload_session, chunk_number)
        # Validate chunk number to prevent path traversal
        sanitized_chunk = chunk_number.to_i.to_s
        Rails.root.join("tmp", "chunks", upload_session.id.to_s, "chunk_#{sanitized_chunk}")
      end
