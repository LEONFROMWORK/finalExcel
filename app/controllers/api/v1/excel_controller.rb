  ...
  module V1
    class ExcelController < ApplicationController
      ...
      def upload
        ...
        excel_file = current_authentication_user.excel_files.create!(
      ...
      def analyze
        ...
        excel_file = current_authentication_user.excel_files.find(file_id)
      ...
      def generate_code
        ...
        begin
          ...
          if excel_context.present? && current_authentication_user.excel_files.exists?
            excel_file = current_authentication_user.excel_files.last
