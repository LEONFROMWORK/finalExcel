  ...
  module V1
    module Users
      class UsersController < ApplicationController
        ...
        def current
          render json: UserSerializer.new(current_authentication_user).as_json
        end
        ...
        def update_credits
          ...
          new_credits = current_authentication_user.credits + amount
          ...
          current_authentication_user.update!(credits: new_credits)
          
          render json: {
            credits: current_authentication_user.credits,
        ...
        def purchase_credits
          ...
          current_authentication_user.update!(credits: current_authentication_user.credits + selected_plan[:credits])
